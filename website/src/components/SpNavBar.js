...
function SpNavbar() {
  ...
  return (
    <Navbar expand="lg" className="pastel-navbar">
      <Container>
        <Navbar.Brand as={Link} to="/" className="brand-title">CAMTT</Navbar.Brand>
          ...
          <Nav className="ml-auto d-flex align-items-center">
            {currentUser ? (
              <>
                ...
                <Button className="pastel-logout-button" onClick={handleLogout}>Logout</Button>
              </>
            ) : (
              <Button className="pastel-help-button" onClick={handleHelp}>Help</Button>
            )}
          </Nav>
        </Navbar.Collapse>
      </Container>
